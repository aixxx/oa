...
use App\Repositories\PAS\PaymentOrderRepository;
use Request;
use Auth;
...
class PaymentOrderController extends Controller
{
    ...
    {
        $this->repository = app()->make(PaymentOrderRepository::class);
    }
    ...
    public function setAddOne() {
        $user = Auth::user();
        $array = Request::input();
        return $this->repository->setAddOne($user,$array);
    }
    public function getOneInfo() {
        $user = Auth::user();
        $array = Request::input();
        return $this->repository->getOneInfo($user,$array);
    }
    public function getOrder() {
        $user = Auth::user();
        $array = Request::input();
        return $this->repository->getOrder($user,$array);
    }
    public function getPassInfoTow() {
        $user = Auth::user();
        $array = Request::input();
        return $this->repository->getPassInfoTow($user,$array);
    }
    public function getPassInfoOne() {
        $user = Auth::user();
        $array = Request::input();
        return $this->repository->getPassInfoOne($user,$array);
    }
}
