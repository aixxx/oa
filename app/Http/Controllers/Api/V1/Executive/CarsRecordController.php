...
use App\Repositories\Executive\CarsRecordRepository;
use App\Services\AttendanceApi\CountsService;
use Request;

class CarsRecordController extends BaseController
{
    public $repository;
    //构造函数
    function __construct() {
        $this->repository = app()->make(CarsRecordRepository::class);
    }
