...
class WageEndListener
{
    ...
    public function handle($event)
    {
        ...
        try {
            ...
            UsersDetailInfo::where('user_id', $data['user_id'])->update(["user_type" => UsersDetailInfo::STATUS_IS_POSITIVE]);
            $arr = [
                "user_id" => $data['user_id'],
                "content" => User::$growthrecord[User::STATUS_IS_WAGE],
                "type" => "正式员工"
            ];
            GrowthRecode::UserGrowthRecode($arr);
