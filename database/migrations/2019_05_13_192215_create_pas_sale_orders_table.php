...
CREATE TABLE `pas_sale_orders` (
  ...
  `user_id` bigint(20) unsigned DEFAULT '0' COMMENT '申请用户编号',
  `buy_user_id` bigint(20) unsigned DEFAULT '0' COMMENT '销售的客户',
  ...
  `status` tinyint(4) DEFAULT NULL COMMENT '状态 0草稿 1审核中 2已撤回 3已退回 5审核完成',
  `entrise_id` int(11) DEFAULT '0' COMMENT '审核流程id',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='进销存采购表';
EOF;
        DB::statement($sql);
    }
