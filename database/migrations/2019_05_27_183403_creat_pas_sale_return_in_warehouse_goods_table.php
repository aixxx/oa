...
class CreatPasSaleReturnInWarehouseGoodsTable extends Migration
{
    /**
     * Run the migrations.
     *
...
CREATE TABLE `pas_sale_return_in_warehouse_goods` (
  ...
  `return_order_goods_id` int(11) DEFAULT '0' COMMENT '销售单退货商品表主键id',
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='退货订单入库商品表';
EOF;
        DB::statement($sql);
    }
