...
(function (factory) {
    ...
    $(".file_upload").each(function () {
        var fileinput = $(this).fileinput({
            language: 'zh',
            uploadUrl: $(this).attr('data-href'),
            enctype: 'multipart/form-data',
            allowedFileExtensions: ['jpg', 'png', 'bmp', 'jpeg', 'pdf', 'doc', 'docx'],
            uploadExtraData: {
                "_token": $('meta[name="csrf-token"]').attr('content'),
                'file_source': $('[name="file_source"]').val(),
                'file_source_type': $('[name="file_source_type"]').val()
            },
            autoUpload: $(this).attr('data-auto')
        }).on("fileuploaded", function (event, data, previewId, index) {
            $("#" + previewId).attr("data-file-id", data.response.data.file_upload.id);
            $('.file_upload').trigger('change_sp');
