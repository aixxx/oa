 ...
 * Generated for Laravel 5.6.24 on 2018-07-12 10:27:10.
 *
...
namespace Kuainiu\Facades { 
    ...
    class Kuainiu {
        ...
        {
            return \Kuainiu\KuainiuApi::getUser($uid);
        }
         ...
         * @static 
         */ 
        public static function encrypt($uid, $data)
        {
            return \Kuainiu\KuainiuApi::encrypt($uid, $data);
        }
         ...
         * @static 
         */ 
        public static function decrypt($uid, $data)
        {
            return \Kuainiu\KuainiuApi::decrypt($uid, $data);
        }
...
namespace  { 
    ...
    class Kuainiu extends \Kuainiu\Facades\Kuainiu {}
