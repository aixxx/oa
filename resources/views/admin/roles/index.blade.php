                                ...
                                <td>
                                    @foreach ($role->abilities as $ability)
                                        <span style="margin-top: 10px;" class="badge badge-info badge-many" data-toggle="tooltip" data-placement="top"
                                              title="{{ $ability->name }}">{{ $ability->title }}</span>
                                    @endforeach
                                </td>
                                <td>
                                    <a href="{{ route('admin.roles.edit',[$role->id]) }}" class="btn btn-sm btn-primary">编辑</a>

                                    <a style="margin-top: 10px;" href="javascript:;" data-href="{{ route('admin.roles.destroy',[$role->id]) }}"
