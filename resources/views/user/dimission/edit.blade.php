@extends('layouts.main',['title' => '编辑离职信息'])
    ...
    <section class="page-content container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">编辑{{  $user->chinese_name  }}离职信息</h3>
            </div>
            <div class="card-body">
                <form action="{{  route('dimission.update')  }}" method="POST">
                    @csrf
                    <input type="hidden" name="user_id" value="{{  $user->id  }}">
                    <input type="hidden" name="id" value="{{  $dimission->id  }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group col-10">
                            ...
                            <textarea type="text" rows="3" cols="20" name="reason" class="form-control"
                                      style="resize:none">{{  $dimission->reason }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group col-10">
                            ...
                            <textarea type="text" rows="3" cols="20" name="interview_result" class="form-control"
                                      style="resize:none">{{  $dimission->interview_result }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group col-10">
                            ...
                            <input type="text" name="note" class="form-control" value="{{  $dimission->note  }}">
                        </div>
                    </div>
                    <div class="text-left">
