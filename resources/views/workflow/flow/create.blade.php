...
@section('content')
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col">
                <div class="card">
                    <form class="form-horizontal" action="{{route('workflow.flow.store')}}" method="POST">
                        {{csrf_field()}}
                        <h5 class="card-header">新建流程</h5>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5"><textarea class="form-control" name="introduction" placeholder="流程说明"></textarea></div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label text-right col-md-3">是否显示</label>
                                <div class="col-md-5">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_show_show" name="is_show" class="form-check-input">
                                        <label class="form-check-label" for="is_show_show">显示</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_show_hide" name="is_show" class="form-check-input">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="icon_url" placeholder="icon">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label text-right col-md-3">前端填写路由</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="route_url" placeholder="前端路由">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label text-right col-md-3">前端展示路由</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="show_route_url" placeholder="前端展示路由">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    {!! Form::select('departments_ids[]', $departments, old('departments_ids'), ['class' => 'form-control select2','multiple' => 'multiple']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    {!! Form::select('users_ids[]', $users, old('users_ids'), ['class' => 'form-control select2','multiple' => 'multiple']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
