    ...
    <div class="navbar-inner">
        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav">
                    <li><a href="{{route('workflow.flow.index')}}">工作流</a></li>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        var _canvas = $("#flowdesign_canvas").Flowdesign({
            ...
            ,canvasMenus:{
                "add": function(t) {
                    ...
                    var url="{{route('workflow.process.store')}}";
            ...
            ,fnClick:function(){
                ...
                ajaxModal('/workflow/process/attribute?id='+activeId,function(){
                    //alert('加载完成执行')
                });
            }
            ,fnDbClick:function(){
        ...
        $("#leipi_clear").bind('click',function(){
            ...
            // }
            // layer.msg('发布流程');
            $.post('/workflow/flow/publish',{"flow_id":the_flow_id},function(data){
                // console.log(data)
                if(data.status_code==0){
