@extends('layouts.main',['title' => '添加班值'])

@section('content')
    <header class="page-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h1 class="separator">添加班值</h1>
                <nav class="breadcrumb-wrapper" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/')}}"><i class="icon dripicons-home"></i></a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)"></a>班值管理</li>
                        <li class="breadcrumb-item active" aria-current="page">添加班值</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="page-content container-fluid">
        <div class="card">
            <div class="card-body">
                <form action="{{  route('attendance.duty.store')  }}" method="POST">
                {{--<form action="" method="POST">--}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="class_title" class="form-control" value="{{  old('class_title')  }}">
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="input-group col-md-7">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control  z-index-fix" placeholder=""
                                           name="class_begin_at" value="{{  old('class_begin_at')  }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-10">
                            ...
                            <div class="input-group col-md-7">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control z-index-fix" placeholder=""
                                           name="class_end_at" value="{{  old('class_end_at')  }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-10">
                            ...
                            <div class="input-group col-md-7">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control  z-index-fix" placeholder=""
                                           name="class_rest_begin_at" value="{{  old('class_rest_begin_at')  }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-10">
                            ...
                            <div class="input-group col-md-7">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control z-index-fix" placeholder=""
                                           name="class_rest_end_at" value="{{ old('class_rest_end_at') }}">
                                </div>
                            </div>
                        </div>
                    </div>
