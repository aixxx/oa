...
;(function ($, window, document, undefined) {
	...
	*/
	...
	Tree.prototype._clickHandler = function (event) {
		...
		}else if ((classList.indexOf('tree-node-action') !== -1)){
	...
	Tree.prototype._renderNode = function (node, previousNode) {
        ...
        if (typeof (this._options.onNodeHover) === 'function') {
            //this.$element.on('click', $.proxy(this._clickHandler, this));
            var callback = this._options.onNodeHover
            node.$el.on('mouseenter mouseleave',function(event){
                callback(event,node);
            });
        }
	...
	Tree.prototype._template = {
		...
		//action: $('<div class="text-center item-action dropdown"><a href="javascript:void(0)" data-toggle="dropdown" class="icon"><i class="fe fe-more-vertical"></i></a><div class="dropdown-menu dropdown-menu-right"><a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-tag"></i> Action </a><a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-edit-2"></i> Another action </a> <a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-message-square"></i> Something else here</a> <div class="dropdown-divider"></div><a href="javascript:void(0)" class="dropdown-item"><i class="dropdown-icon fe fe-link"></i> Separated link</a></div></div>')
	};
